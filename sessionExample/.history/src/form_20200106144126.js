  ...
  handleupdate =  (updatedState) => {
    ...
    //   }    
      ...
      if(this.state.isedit === false){
          ...
          return(<Table userLogin={this.state.username} removeData={this.removedata} editing={this.state.editing}  editData={this.editdata} />)
        
      }
      else  if((this.props.editing === true) && (this.state.isedit === true)){
            // console.log("this.state.username", this.state.username)
