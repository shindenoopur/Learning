...
class Form extends Component{
  ...
  handleupdate =  (updatedState) => {
    ...
    //   this.state.isedit = this.props.editing;
      console.log("this.state.editing", this.state.isedit, this.props.edit)
      console.log("dddd",((this.props.isedit === true) && (this.state.isedit === true)))
        if(this.props.isedit === true && this.state.isedit === false){
            // console.log("this.state.username", this.state.username)
