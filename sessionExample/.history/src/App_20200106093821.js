...
class App extends Component {
  ...
  editdata = (index, value) => {
    console.log("values t be updated", value)
    ...
    this.setState({
      ...
      items: this.state.characters.map((item, itemIndex) => {
        if (itemIndex === index) {
          ...
          return {
            ...item && <Form handleupdate={this.handleupdate} handlesubmit={this.handlesubmit} editing={this.state.editing} changedValue={this.state.changedValue}/>,
            // editing: !item.editing
          }
        }
        return item && <Form handleupdate={this.handleupdate} handlesubmit={this.handlesubmit} editing={this.state.editing} changedValue={this.state.changedValue}/>;
      })
    });
  }
        ...
        */}
        <Switch>
          ...
          <Route path='/viewusers/'>
            ...
            <Table userLogin={uname} characterSet={characters} removeData={this.removedata} editData={this.editdata} /> 
          </Route>
