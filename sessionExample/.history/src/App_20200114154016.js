...
class Game extends React.Component {
  ...
  render() {
    ...
    console.log("Demowinner", demowinner, "p1", !this.state.player1, "p2",!this.state.player2, "names", !this.state.namesEntered)
      ...
      <div>
        <Form className="form">
          ...
          <Col>
            ...
            <FormGroup>
              <button disabled={(!this.state.namesEntered) && (!this.state.player1) && (!this.state.player2==="")} color="primary" onClick={this.start}>Start game</button>
            </FormGroup>
