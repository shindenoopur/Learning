...
class Table extends Component {
  ...
  render() {
    ...
    const {characterSet, removeData, editData, editing} = this.props;  //Receives properties or data sent by parent component
...
if(this.props.editing){
    console.log("properties sent", this.props)
    return <Form characters={this.props.characterSet} editing={this.props.editing}/>
}

else if(this.props.userLogin !== ""){
    console.log("In if")
    return (
       <div>
