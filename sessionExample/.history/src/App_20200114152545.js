        ...
        <Form className="form">
          ...
          <Col>
            <FormGroup>
              ...
              <input type='text' disabled={!this.state.namesEntered && !this.state.isStartClicked} value={player2} name="player2" onChange={this.updatePlayer}></input>
            </FormGroup>
            <FormGroup>
              <Link to="winnerlist"><button disabled={this.state.namesEntered} color="primary" onClick={this.start}>Start game</button></Link>
            </FormGroup>
