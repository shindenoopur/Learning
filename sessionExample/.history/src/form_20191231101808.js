...
class Form extends Component{
    constructor(props){
       ...
       this.initialState = {
            ...
            passwordError:"",
            passwordState: null,
            changedUname: this.props.changedValue,
        };
    ...
    updateDetails(e){
        this.setState({ changedUname: e.target.value });
    }
    changeDetails = (event) => {
    ...
    if(this.state.passwordState === "weak"){
      ...
      console.log("changedValue:", this.state);
        if(this.props.editing === true){
            return( <div className="col-md-12">
                        <form handlesubmit={this.handlesubmit}>
                            <label>UserName</label>
                            <input type="text" name="username" value={uname} onChange={this.updateDetails}/>
