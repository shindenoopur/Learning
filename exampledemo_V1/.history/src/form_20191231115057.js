        ...
        if(this.props.editing === true){
            return( <div className="col-md-12">
                        <form handlesubmit={this.handlesubmit}>
                            ...
                            <input type="text" name="username" value={username} onChange={this.changeDetails}/>
                            ...
                            <button type="submit" className="login-btn " value="submit" onClick={this.updateDetails}>Save</button>
                            </div>
                        </form>
                    </div>
            )
