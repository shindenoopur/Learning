  ...
  render() {
    ...
    if(this.state.showPersons){
       ...
       <div>
         ...
         onchangeHandlerPersons={this.onchangeHandler} 
         deleteHandlerPersons={this.deleteHandler}
    ...
    return (
        ...
        <div className="App">
          <AuthContext.Provider value={{authenticated: this.state.authenticated}}> {/*Used to handle state and props without passing via multiple layers */}
            <Cockpit title={this.props.appTitle} 
            showPersons=
            {this.state.showPersons} 
            persons={this.state.persons} 
            togglePersonHandlerCockpit={this.togglePersonHandler}
            loginFunc={this.loginHandler}
            />
