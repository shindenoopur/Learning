    ...
    return (
      <div className="App">
        <div className="">
          ...
          <Person name={this.state.persons[0].name} age={this.state.persons[0].age} click={this.switchHandler.bind(this, "Pooja")} onChangeHandler={onchangeHandler}>Hobbie: Cycling</Person>
