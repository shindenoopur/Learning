...
const Cockpit=(props)=>{
    ...
    return(
        ...
        <div>
            ...
            <StyledButton conditionChange={props.showPersons} ref={togglePersonRef} onClick={context.togglePersonHandlerCockpit}>click me</StyledButton>
            <AuthContext>{(context)=><StyledButton onClick={props.loginFunc}>Login</StyledButton>}</AuthContext>
        </div>
    );
};
