...
class Form extends Component{
    ...
    render(){
        ...
        return(
            <form handlesubmit={this.handlesubmit}>
                ...
                <label>Job</label>
                <input type="text" name="email" value={job} onChange={this.changeDetails} placeholder="Enter your job post" />
    ...
    //       <input type="text" className="login-input" value={username}  placeholder="userName"/>
